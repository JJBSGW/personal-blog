...
export type VisitLogWhereInput = {
  ...
  date?: Prisma.DateTimeFilter<"VisitLog"> | Date | string
}
...
export type VisitLogScalarWhereWithAggregatesInput = {
  ...
  date?: Prisma.DateTimeWithAggregatesFilter<"VisitLog"> | Date | string
}
...
export type VisitLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "path" | "ip" | "userAgent" | "date", ExtArgs["result"]["visitLog"]>
...
export interface VisitLogFieldRefs {
  ...
  readonly date: Prisma.FieldRef<"VisitLog", 'DateTime'>
}
